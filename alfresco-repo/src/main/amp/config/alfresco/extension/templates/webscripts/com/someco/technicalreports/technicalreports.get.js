...
function main() {
	...
	var whitepapers = search.luceneSearch("PATH:\"/app:company_home/cm:Belvac/Reports/Published/*\" +TYPE:\"{http://www.someco.com/model/content/1.0}technicalReport\" +@sc\\:isActive:true");
