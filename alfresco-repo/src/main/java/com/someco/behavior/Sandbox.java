...
{
	private static String s = "Office of Device Evaluation,,\"Division of Anesthesiology, General Hospital, Infection Control, and Dental Devices \",DAGRID,Anesthesiology Devices Branch ,ANDB";
